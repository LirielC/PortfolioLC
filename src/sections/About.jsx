  ...
  return (
    <section id="about" className="flex flex-col items-center justify-center" style={{ minHeight: 'calc(100vh - 112px)' }}>
      <div className="w-full max-w-xl mx-auto bg-white/40 backdrop-blur-2xl border border-white/40 shadow-xl rounded-3xl px-4 py-8 sm:px-10 sm:py-14 flex flex-col items-center relative overflow-hidden">
        ...
        <span className="text-cyan-900/80 text-lg font-semibold mb-6 drop-shadow text-center">Estudante de Ciência da Computação pela a Universidade do Estado do Rio de Janeiro</span>
        ...
        <ul className="w-full flex flex-col gap-3 mb-8">
          ...
          <li className="flex items-center gap-2 text-cyan-900/80 font-sans text-base"><span className="text-cyan-700">•</span> Foco em desenvolvimento de software e ciência de dados</li>
        </ul>
