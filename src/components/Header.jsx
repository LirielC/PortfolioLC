...
export default function Header({ title, section, children }) {
  return (
    <header className="fixed top-0 left-0 w-full h-16 min-h-[64px] flex items-center justify-center sm:justify-start sm:pl-[272px] bg-white/30 backdrop-blur-xl border-b border-white/40 shadow z-50">
